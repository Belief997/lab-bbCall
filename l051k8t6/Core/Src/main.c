...
int main(void)
{
  ...
  /* definition and creation of GPIOTest */
  osThreadDef(GPIOTest, StartGPIO, osPriorityNormal, 0, 128);
  GPIOTestHandle = osThreadCreate(osThread(GPIOTest), NULL);

  /* definition and creation of TaskTest */
...
/* USER CODE BEGIN Header_StartGPIO */
/**
* @brief Function implementing the GPIOTest thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartGPIO */
void StartGPIO(void const * argument)
{
  /* USER CODE BEGIN StartGPIO */
  /* Infinite loop */
  for(;;)
  {
	static char p1 = 1;
...
/* USER CODE BEGIN Header_StarTest */
/**
* @brief Function implementing the TaskTest thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StarTest */
void StarTest(void const * argument)
{
  /* USER CODE BEGIN StarTest */
  /* Infinite loop */
  for(;;)
  {
      static char p0 = 0;
